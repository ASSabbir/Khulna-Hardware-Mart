  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-7">
        <div className="max-w-6xl mx-auto flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-base mt-0.5">Manage all your customers in one place</p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
        ...
        <p className="text-center text-gray-400 text-base pb-4">Khulna Hardware Mart · Customers </p>
      </div>
    </div>
  );
}