    ...
    <div className="bg-blue-900 py-12 overflow-hidden space-y-5">
      ...
      >
        {CAT_LOOP.map(({ icon, label }, i) => (
          <div
            key={i}
            className="inline-flex items-center gap-2.5 bg-white/6 border border-white/10 text-white text-sm font-semibold px-5 py-2.5 rounded-full shrink-0 hover:bg-blue-700/40 hover:border-blue-600/50 transition-colors duration-300 cursor-default"
          >
      ...
      >
        {BRAND_LOOP.map((brand, i) => (
          <div
            key={i}
            className="inline-flex items-center gap-2.5 bg-orange-500/30 border border-orange-500/30 text-orange-300 text-sm font-semibold px-5 py-2.5 rounded-full shrink-0 hover:bg-orange-700/40 hover:text-white transition-colors duration-300 cursor-default"
          >
