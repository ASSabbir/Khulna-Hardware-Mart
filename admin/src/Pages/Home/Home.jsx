...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <section className="relative   overflow-hidden b-1 bg-linear-to-br from-blue-900 via-blue-800 to-blue-900 text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <NavLink
                  to="/dashboard"
                  className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-4 rounded-xl transition-all transform hover:scale-105"
                >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              A complete business management solution tailored for hardware
              stores
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Access your business data anytime, anywhere",
                  },
                  {
                    icon: <FiTrendingUp />,
                    title: "Growth Analytics",
                    desc: "Track performance and grow your business with insights",
                  },
                  {
                    icon: <FiStar />,
                    title: "Free Support",
            ...
            <div className="grid grid-cols-1 gap-4">
              <img
                ...
                src="https://s3-media0.fl.yelpcdn.com/bphoto/22DMAka_t5kjGL_gYAv3Sw/1000s.jpg"
                alt=""
              />
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center bg-linear-to-br from-orange-500 to-orange-600 rounded-3xl p-12 text-white">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Ready to Transform Your Business?
          </h2>
          <p className="text-orange-100 text-lg mb-8">
            Join thousands of happy hardware businesses using our management
            system
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <NavLink
              to="/dashboard"
              className="bg-white text-orange-600 font-bold px-8 py-4 rounded-xl hover:bg-gray-100 transition"
            >
              Get Started Now
            </NavLink>
          </div>
