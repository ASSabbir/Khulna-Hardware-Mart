...
const OWNER_IMAGE =
  "https://i.pinimg.com/736x/d0/dd/2c/d0dd2c8bb30ef5281ebb4472f1cc71fa.jpg"; // set to imported image when ready
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start gap-6">
              ...
              <div className="w-64 h-72 sm:w-72 sm:h-80 rounded-3xl overflow-hidden border-4 border-white shadow-2xl bg-blue-800 flex items-center justify-center">
                {OWNER_IMAGE ? (
                  ...
                  <div className="flex flex-col items-center gap-4 text-white/60 px-6 text-center">
                    ...
                    <p className="text-sm">
                      Replace <code className="text-blue-300">OWNER_IMAGE</code>{" "}
                      with
                      <br />
                      the actual photo import
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl px-7 py-5 shadow-sm w-full max-w-xs lg:max-w-full">
              ...
              <p className="text-gray-500 text-sm mt-1">
                Khulna Hardware Mart — Est. 1990
              </p>

              {/* Contact links */}
              <div className="mt-4 pt-4 border-t border-gray-100 space-y-2">
                <a
                  href="tel:+8801931272839"
                ...
                <a
                  href="mailto:sislamkhulna1990@gmail.com"
                  className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-blue-700 transition font-medium"
                >
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-5">
              MD Abdus Sattar founded Khulna Hardware Mart in 1990 with a single
              goal — to provide the people of Khulna with genuine, quality
              hardware products at honest prices. What started as a modest shop
              on Khanjahan Ali Road has grown into the region's most
              comprehensive hardware destination.
            </p>

            <p className="text-gray-600 text-lg leading-relaxed mb-5">
              With over three decades of hands-on experience in the hardware
              trade, he has built lasting relationships with top manufacturers
              and distributors across Bangladesh, ensuring that every product on
              the shelf is authentic and fairly priced.
            </p>

            <p className="text-gray-600 text-lg leading-relaxed mb-10">
              His philosophy has always been straightforward — treat every
              customer with respect, give honest advice, and never compromise on
              product quality. That philosophy is the foundation on which 5,000+
              loyal customers have been built.
            </p>
