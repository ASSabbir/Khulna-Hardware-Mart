...
const CONTACT = [
  {
    ...
    label: "Address",
    value: "280 Khanjahan Ali Road, Rahmania Madrasha Complex, Khulna",
  },
  {
    icon: <FiPhone size={18} />,
    label: "Phone",
    value: "02477-721990  ·  +880 1931-272839  ·  +880 1679-123205",
  },
  {
    icon: <FiMail size={18} />,
    label: "Email",
    value: "sislamkhulna1990@gmail.com",
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
              Khulna's Most Trusted
              <br />
              <span className="text-orange-500">Hardware Store</span>
            </h2>

            <p className="text-gray-600 text-lg leading-relaxed mb-5">
              Established in 1990, Khulna Hardware Mart has spent over three
              decades building a reputation that every contractor, builder, and
              homeowner in Khulna can rely on. Located at 280 Khanjahan Ali Road
              inside the Rahmania Madrasha Complex, our showroom carries more
              than 20,000 products across plumbing, paints, tools, electrical,
              and more.
            </p>

            <p className="text-gray-600 text-lg leading-relaxed mb-8">
              We are not an online store — we believe the best hardware
              experience happens in person. Walk into our showroom, speak with
              our expert staff, see the products yourself, and leave with
          ...
          <div className="flex flex-col gap-6">
              ...
              {STATS.map(({ value, label, icon }, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      className={`text-sm mt-1 font-medium ${i < 2 ? "opacity-70" : "text-gray-500"}`}
                    >
                      {label}
                    </div>
                  </div>
            ...
            {/* Visit us card */}
            <div className="bg-linear-to-br from-blue-700 to-blue-900 rounded-2xl p-7 text-white">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-orange-100 text-base leading-relaxed mb-5">
                We are an in-store experience. Come see our full range of
                20,000+ products, get expert advice from our team, and leave
