...
import {
  ...
  FiTrendingUp, FiActivity, FiInbox, FiPrinter,
} from "react-icons/fi";
            ...
            <div className="flex items-center gap-4 min-w-0">
              ...
              {invoice && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/10 hover:bg-white/15 text-white text-xs font-semibold shrink-0"
                >
