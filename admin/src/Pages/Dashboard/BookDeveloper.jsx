      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
        <div className="bg-white border border-gray-200 rounded-3xl p-12 max-w-md w-full text-center shadow-sm">
          ...
          <p className="text-gray-500 text-lg mb-2">
            Your bug report has been sent to the BuildMart team!
          </p>
          <p className="text-gray-400 text-base mb-8">
            We'll squash that bug ASAP. Thanks for keeping the system clean! 🧹
          </p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-6">
        ...
        {status === "error" && (
          <div className="bg-red-50 border border-red-200 rounded-2xl p-5 flex items-center gap-3">
            <FiAlertTriangle size={22} className="text-red-500 shrink-0" />
            <div>
              <p className="text-red-800 text-base font-semibold">
                Oops! Email failed to send{" "}
              </p>
              <p className="text-red-600 text-base mt-0.5">
                Make sure your EmailJS credentials are set up correctly. Check
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-7">
          ...
          <p className="text-gray-500 text-base mb-6">
            Pick the priority level honestly{" "}
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {PRIORITIES.map(({ value, label, emoji, desc, color }) => (
              ...
              >
                <div
                  className={`text-3xl  rounded-full w-7 h-7 mb-2 ${
                    emoji === "a"
                      ? "bg-green-500"
                      : emoji === "b"
                        ? "bg-yellow-500"
          ...
          {errors.priority && (
            <p className="text-red-500 text-sm mt-3 flex items-center gap-1">
              <FiAlertCircle size={13} /> {errors.priority}
            </p>
          )}
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-7">
          ...
          <p className="text-gray-500 text-base mb-6">
            Help us find it faster by telling us where it lives
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
            <div className="mb-5">
              <label className="block text-base font-semibold text-gray-700 mb-2">
              ...
              {errors.category && (
                <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                  <FiAlertCircle size={13} /> {errors.category}
                </p>
              )}
            </div>
            <div className="mb-5">
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-7">
          ...
          <p className="text-gray-500 text-base mb-6">
            The more detail, the faster we fix it. No pressure though{" "}
          </p>
          ...
          <Field
            ...
            value={form.title}
            onChange={set("title")}
            placeholder='e.g. "Sales total shows wrong amount"'
            error={errors.title}
            required
          />
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex items-start gap-3">
          <FiInfo size={20} className="text-blue-500 shrink-0 mt-0.5" />
          <div>
            <p className="text-blue-800 text-base font-semibold">
              How this works
            </p>
            <p className="text-blue-700 text-base mt-1">
              When you hit Submit, your bug report is emailed directly to the
              BuildMart dev team. We'll review it and get back to you at your
        ...
        <p className="text-center text-gray-400 text-base pb-6">
          Khulna Hardware Mart · Bug Tracker · Thanks for keeping the system
          clean!
        </p>
      </div>
    </div>
